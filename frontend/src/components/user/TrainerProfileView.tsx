...
function TrainerProfileView() {
  ...
  return (
    <>
      ...
      <div className="absolute top-36 md:top-40 left-8 md:left-32 flex items-center justify-center">
        ...
        <div className="flex flex-col ml-10 ">
          <h1 className="text-4xl font-bold  mt-40  rounded-lg">Trainer1</h1>
          <h2 className="text-xl font-medium text-gray-700 mt-2">Boxing</h2>
        </div>
      </div>
    ...
    <div className="bg-blue-50 rounded-md p-10 mt-10 ml-10 mr-36">
        <h1 className="text-3xl font-semibold mb-7">About Trainer1</h1>
        ...
        <p className="mt-5 font-medium">Languages: English</p>
    </div>
      </div>
    </>
  );
