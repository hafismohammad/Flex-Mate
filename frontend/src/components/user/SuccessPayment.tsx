...
//   useEffect(() => {
//     const bookingKey = `bookingCreated-${stripe_session_id}`;
//     const bookingCreated = localStorage.getItem(bookingKey); // Check if booking was created
...
//           // Mark booking as created in localStorage
//           localStorage.setItem(bookingKey, 'true');
//         } catch (error) {
//           console.error('Error creating booking:', error);
//         } finally {
...
//     // Run the booking process if not previously completed
//     if (!bookingCreated) {
//       createBooking();
//     }
//   }, [stripe_session_id, sessionId, userId, socket]);  // Only run if the params change
